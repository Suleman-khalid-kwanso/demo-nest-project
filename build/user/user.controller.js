...
var user_input_dto_1 = require("./dto/user.input.dto");
var user_service_1 = require("./user.service");
var UserController = /** @class */ (function () {
    function UserController(userService) {
        this.userService = userService;
    }
    UserController.prototype.fetchUsers = function () {
        return this.userService.getAllUsers();
    };
    //how to resolve this type of promise
    UserController.prototype.findUser = function (firstName) {
        return this.userService.findOne(firstName);
    };
    UserController.prototype.signUp = function (user) {
    ...
    UserController.prototype.loginUser = function (email, password) {
        var res = this.userService.logged({ email: email, password: password });
        return res;
    };
    ...
    UserController.prototype.deleteUser = function (id) {
        return __awaiter(this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.userService.deleteUser(Number(id))];
                    case 1: return [2 /*return*/, _a.sent()];
                }
            });
        });
    };
    UserController.prototype.updateUser = function (userInput, id) {
