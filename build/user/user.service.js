...
var UserService = /** @class */ (function () {
    function UserService(userRepository, authService) {
        this.userRepository = userRepository;
        this.authService = authService;
    }
    UserService.prototype.findOne = function (firstName) {
    ...
    UserService.prototype.logged = function (loginDetails) {
        return __awaiter(this, void 0, void 0, function () {
            var login, isMatch, error_1;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 3, , 4]);
                    ...
                    case 1:
                        login = _a.sent();
                        return [4 /*yield*/, bcrypt.compare(loginDetails.password, login.password)];
                    case 2:
                        isMatch = _a.sent();
                        if (isMatch) {
                            return [2 /*return*/, 'Successfully login'];
                        }
    ...
    UserService.prototype.createUser = function (payload) {
        return __awaiter(this, void 0, void 0, function () {
            var login, hash, user, password, lastName, result, token, error_2;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        _a.trys.push([0, 5, , 6]);
                    ...
                    case 3:
                        ...
                        password = payload.password, lastName = payload.lastName, result = __rest(payload, ["password", "lastName"]);
                        token = this.authService.generateJWT(result);
                        return [2 /*return*/, token];
                    case 4: return [2 /*return*/, 'Email already exist !'];
                    case 5:
                        error_2 = _a.sent();
                        console.log(error_2);
                        throw new common_1.HttpException(error_2, common_1.HttpStatus.NOT_ACCEPTABLE);
    ...
    UserService.prototype.updateUserInfo = function (payload) {
        return __awaiter(this, void 0, void 0, function () {
            var error_4;
            return __generator(this, function (_a) {
                switch (_a.label) {
