...
var BooksController = /** @class */ (function () {
    ...
    BooksController.prototype.getBook = function (bookID) {
        return __awaiter(this, void 0, void 0, function () {
            var book;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.booksService.getBook(bookID)];
                    case 1:
                        book = _a.sent();
    ...
    BooksController.prototype.addBook = function (createBookDTO) {
        return __awaiter(this, void 0, void 0, function () {
            var book;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.booksService.addBook(createBookDTO)];
                    case 1:
                        book = _a.sent();
                        return [2 /*return*/, book];
                }
    ...
    BooksController.prototype.deleteBook = function (query) {
        return __awaiter(this, void 0, void 0, function () {
            var books;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.booksService.deleteBook(query.bookID)];
                    case 1:
                        books = _a.sent();
                        return [2 /*return*/, books];
                }
    ...
    BooksController.prototype.globalAccess = function () {
    ...
    __decorate([
        common_1.Get('glob/me'),
        __metadata("design:type", Function),
        __metadata("design:paramtypes", []),
        __metadata("design:returntype", void 0)
    ], BooksController.prototype, "globalAccess", null);
