...
const database_module_1 = require("../dbConnection/database.module");
const photo_provider_1 = require("./photo.provider");
...
PhotoModule = __decorate([
    common_1.Module({
        ...
        providers: [...photo_provider_1.photoProviders, photo_service_1.PhotoService],
